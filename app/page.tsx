...
import { Camera, FlipHorizontal, MoonIcon, PersonStanding, Sliders, SunIcon, Video, Volume2 } from 'lucide-react';
...
const HomePage = (props: Props) => {
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* Right Divsion -> container for config panel */}
      ...
      {/* {loading && <div className='z-50 absolute w-full h-full flex items-center justify-center bg-primary'>
        Getting things ready . . . <Rings height={50} color='red' /></div>} */}
    </div>
  )
  ...
  function startRecording(){
    if(webcamRef.current && mediaRecorderRef.current?.state !== 'recording'){
      ...
      console.log('userSTARTrecording()', mediaRecorderRef.current)
